...
describe("PluginRescope", () => {
  ...
  describe("rescope with project scope", () => {
    it("creates JsonConfig with settings.json when scope is project", () => {
      vi.mocked(
        ClaudeCodeToolbox.prototype.validateInstallation,
      ).mockReturnValue("1.0.27");
      vi.mocked(
    ...
    it("creates JsonConfig with settings.local.json when scope is local", () => {
      vi.mocked(
        ClaudeCodeToolbox.prototype.validateInstallation,
      ).mockReturnValue("1.0.27");
      vi.mocked(
    ...
    it("registers the plugin with project scope in global binding", () => {
      vi.mocked(
        ClaudeCodeToolbox.prototype.validateInstallation,
      ).mockReturnValue("1.0.27");
      vi.mocked(
    ...
    it("skips when plugin already has project-scoped binding and is enabled", () => {
      vi.mocked(
        ClaudeCodeToolbox.prototype.validateInstallation,
      ).mockReturnValue("1.0.27");
      vi.mocked(
    ...
    it("does not add binding when plugin is absent from global config", () => {
      vi.mocked(
        ClaudeCodeToolbox.prototype.validateInstallation,
      ).mockReturnValue("1.0.27");
      vi.mocked(
  ...
  describe("rescope with remove command", () => {
    ...
    it("does not remove when plugin has no binding for the current project", () => {
      vi.mocked(
        ClaudeCodeToolbox.prototype.validateInstallation,
      ).mockReturnValue("1.0.27");
      vi.mocked(
    ...
    it("does not remove when plugin has no bindings at all", () => {
      vi.mocked(
        ClaudeCodeToolbox.prototype.validateInstallation,
      ).mockReturnValue("1.0.27");
      vi.mocked(
    ...
    it("reports that the plugin is not rescoped when no binding matches", () => {
      vi.mocked(
        ClaudeCodeToolbox.prototype.validateInstallation,
      ).mockReturnValue("1.0.27");
      vi.mocked(
      ...
      const output = allOutput();
      expect(output).toContain("my-plugin@owner");
      expect(output).toContain("not rescoped");
    });
  });
